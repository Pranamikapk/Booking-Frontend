      ...
      <Card className="overflow-hidden shadow-lg rounded-lg">
        ...
        <div className="bg-gray-50 px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
          <Button className="w-full sm:w-auto bg-blue-500 text-white hover:bg-blue-600 transition duration-200">
            <Link to="/admin/hotels" className="flex items-center justify-center">Back to Hotels</Link>
          </Button>
          {/* <Link to={`/manager/hotel/${hotelId}/edit`} className="w-full sm:w-auto text-blue-500 underline">
            Edit Hotel
          </Link> */}
        </div>
      </Card>
